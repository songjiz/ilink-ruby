...
class BotTest < Minitest::Test
  ...
  def test_upload_url_sends_params
    ...
    new_bot.get_upload_url(media_type: ILink::UploadMediaType::IMAGE, to_user_id: "u1", rawsize: 1024)
  end
